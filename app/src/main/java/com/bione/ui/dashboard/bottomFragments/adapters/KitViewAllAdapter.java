...
public class KitViewAllAdapter extends RecyclerView.Adapter<KitViewAllAdapter.MyViewHolder> {
    ...
    public KitViewAllAdapter(final Context mContext, final ArrayList<CrouselData> crouselDataArrayList, final int kitOrderSize) {
...
//            tvText = v.findViewById(R.id.tvText);
    ...
    @NonNull
    @Override
    public KitViewAllAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
